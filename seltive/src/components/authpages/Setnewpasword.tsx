  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center p-[10%] text-center'>
               ...
               <p className='text-gray-500 font-bold mb-5'>
                ...
                <form action="">
                  <span className=' relative -left-[190px]'>Password</span><br/>
                        <input type="password" placeholder='Enter your password.' className='mb-5 p-1 border border-black outline-none rounded-[5px] w-[450px]' />
                        <span className='flex justify-between m-1'>
                            ...
                            <input type="checkbox" name="Show Passcord" id="" className='text-xs relative -top-5 left-[90px] ' />
                            <span className='relative -top-5 text-xs'>Show password </span>
                        </span>
                        <Link to='/ressetsuccespage'>
                        <input type="button" value="Save new password" className='bg-indigo-700 text-white p-1 cursor-pointer rounded-[5px] w-[80%]' />
                        </Link>
