  ...
  return (
    <div className='w-[350px] '>
               ...
               https://images.unsplash.com/photo-1518133910546-b6c2fb7d79e3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80
                " alt="" className='w-[350px] h-[200px] rounded-t-xl' />
                    <div className='bg-white w-[350px] p-3 h-[250px] shadow-xl rounded-b-md'>
                        ...
                        <ul className='list-none p-2'>
                            ...
                            <li className='font-semibold text-sm'>
                              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                               Dignissim purus turpis sed id. Facilisis placerat at massa 
                               vitae volutpat mus. Scelerisque cursus porttitor vel turpis. 
                              Adipiscing nec etiam adipiscing nunc, risus orci, amet est.
                            
                            </li>
                        </ul>
                        <span className="flex w-full justify-between p-2 items-center">
                          <span>TZS 2000</span>
                          <button className="bg-indigo-600 w-[80px] h-[25px]">
                          BUY
                          </button>
                        </span>
                    </div>
